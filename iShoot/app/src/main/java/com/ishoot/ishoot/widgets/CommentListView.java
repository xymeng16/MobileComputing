package com.ishoot.ishoot.widgets;
...
import com.ishoot.ishoot.spannable.CircleMovementMethod;
import com.ishoot.ishoot.spannable.SpannableClickable;
...
public class CommentListView extends LinearLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color, getResources().getColor(R.color.colorDefaultPraiseItem));
            itemSelectorColor = typedArray.getColor(R.styleable.PraiseListView_item_selector_color, getResources().getColor(R.color.colorDefaultPraiseItemSelector));
    ...
    public void notifyDataSetChanged(){
        ...
        for(int i=0; i<mDatas.size(); i++){
            ...
            if(view == null){
                throw new NullPointerException("listview item_rank layout is null, please check getView()...");
            }
