package com.ishoot.ishoot.utils;
...
import com.ishoot.ishoot.bean.User;
...
public class DatasUtil {
	...
	public static final String[] HEADIMG = {
			...
			"http://cdn.duitang.com/uploads/item_rank/201408/13/20140813122725_8h8Yu.jpeg",
	...
	static {
		...
		p1.url = "http://f.hiphotos.baidu.com/image/pic/item_rank/faf2b2119313b07e97f760d908d7912396dd8c9c.jpg";
		p1.w = 640;
		p1.h = 792;

		PhotoInfo p2 = new PhotoInfo();
		p2.url = "http://g.hiphotos.baidu.com/image/pic/item_rank/4b90f603738da977c76ab6fab451f8198718e39e.jpg";
		p2.w = 640;
		p2.h = 792;

		PhotoInfo p3 = new PhotoInfo();
		p3.url = "http://e.hiphotos.baidu.com/image/pic/item_rank/902397dda144ad343de8b756d4a20cf430ad858f.jpg";
		p3.w = 950;
		p3.h = 597;

		PhotoInfo p4 = new PhotoInfo();
		p4.url = "http://a.hiphotos.baidu.com/image/pic/item_rank/a6efce1b9d16fdfa0fbc1ebfb68f8c5495ee7b8b.jpg";
		p4.w = 533;
		p4.h = 800;

		PhotoInfo p5 = new PhotoInfo();
		p5.url = "http://b.hiphotos.baidu.com/image/pic/item_rank/a71ea8d3fd1f4134e61e0f90211f95cad1c85e36.jpg";
		p5.w = 700;
		p5.h = 467;

		PhotoInfo p6 = new PhotoInfo();
		p6.url = "http://c.hiphotos.baidu.com/image/pic/item_rank/7dd98d1001e939011b9c86d07fec54e737d19645.jpg";
		p6.w = 700;
		p6.h = 467;
...
//				item_rank.setVideoUrl(videoUrl);
//                item_rank.setVideoImgUrl(videoImgUrl);
//			}
	...
	public static CircleItem createVideoItem(String videoUrl, String imgUrl){
		...
		item.setId(String.valueOf(circleId++));
		item.setUser(curUser);
		//item_rank.setContent(getContent());
		item.setCreateTime("12月24日");

		//item_rank.setFavorters(createFavortItemList());
		//item_rank.setComments(createCommentItemList());
        item.setType("3");// 图片
