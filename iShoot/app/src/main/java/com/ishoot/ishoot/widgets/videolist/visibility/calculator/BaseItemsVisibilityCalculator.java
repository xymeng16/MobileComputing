...
import com.ishoot.ishoot.widgets.videolist.visibility.scroll.ScrollDirectionDetector;
...
public abstract class BaseItemsVisibilityCalculator implements ListItemsVisibilityCalculator{
    ...
    /** Initial scroll direction should be UP in order to set as active most top item_rank if no active item_rank yet*/
