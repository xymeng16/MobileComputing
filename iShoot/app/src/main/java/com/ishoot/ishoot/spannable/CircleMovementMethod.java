package com.ishoot.ishoot.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_COLOR_ID = R.color.colorTransparent;
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.colorDefaultClickable;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = MainActivity.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = MainActivity.getInstance().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
    ...
    public boolean onTouchEvent(TextView widget, Spannable buffer,
        ...
        if(action == MotionEvent.ACTION_DOWN){
            ...
            widget.setBackgroundResource(R.color.colorTransparent);
